...
const totalCategories = computed(() => store.state.pagination?.totalCategories || 0)
const lastPage = computed(() => store.state.pagination?.lastPage || 1)

const startIndex = computed(() => ((currentPage.value - 1) * 10) + 1)
const endIndex = computed(() => Math.min(startIndex.value + 9, totalCategories.value))
...
<div class="mb-1 w-full">
  ...
  <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
      <form class="sm:pr-3 mb-4 sm:mb-0" action="#" method="GET">
          ...
          <input type="text" name="email" id="products-search" v-model="searchQuery" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for products">
          </div>
      </form>
          ...
          <div class="align-middle inline-block min-w-full">
            <div class="shadow overflow-hidden border-l border-black">
              ...
              <thead class="bg-gray-600" id="thead1">
                <tr>
                  <th scope="col" class="w-3/5 p-4 text-left text-xs font-medium text-gray-500 uppercase border-r border-black">
                    Designation
                  </th>
              ...
              <tbody class="bg-white divide-y divide-black">
                ...
                <tr v-for="category in categories.data" :key="category.id" class="hover:bg-gray-100">
                  ...
                  <td class="p-4 whitespace-nowrap space-x-2 border-l border-r border-black">
                    <button @click="openEditModal(category)" data-modal-toggle="product-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                      <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                 
                    </button>
                    <button @click="openDeleteModal(category);" type="button" data-modal-toggle="delete-product-modal" class="text-white bg-orange-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
